...
class GetMYST
  ...
  def start_download
    ...
    page = @agent.get("http://mystcomic.smackjeeves.com/comics/1432774/page-1/")
  ...
  def chapter_directory(chapter_id)
    "myst_comics/myst_chapter_#{chapter_id}"
  end
  ...
  def zip_file_path(chapter_id)
    ...
    "#{directory_name}/myst_chapter_#{chapter_id}.cbz"
  end
